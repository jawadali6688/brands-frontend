...
const CreatePost = ({ open, setOpen }) => {
  ...
  const fileChangeHandler = async (e) => {
    ...
    if (file) {
      ...
      setFileType(fileType); // Set file type to either image or video
  ...
  const createPostHandler = async () => {
    ...
    if (file) formData.append("media", file); // Append the file (image or video)
